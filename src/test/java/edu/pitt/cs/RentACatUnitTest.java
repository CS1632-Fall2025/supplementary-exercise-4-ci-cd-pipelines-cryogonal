...
public class RentACatUnitTest {
	...
	public void testGetCatNullNumCats0() {
		try {
			...
			assertEquals("System output should match", "Invalid cat ID." + newline, out.toString());
		} catch (Exception e) {
	...
	public void testListCatsNumCats0() {
		assertEquals("List of cats should be empty", "", r.listCats());
	}
	...
	public void testListCatsNumCats3() {
		...
		assertEquals("Return value should be...", 
	...
	public void testRenameNumCat3() {
		...
		assertTrue("renameCat should return true", r.renameCat(2, "Garfield"));
	...
	public void testRentCatNumCats3() {
		...
		assertTrue("rentCat should return true", r.rentCat(2));
		verify(c2).rentCat();
